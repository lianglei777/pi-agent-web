...
export const zh = {
  ...
  chat: {
    ...
    message: {
      ...
      creating: "创建中...",
      cancel: "取消",
      editConfirmTitle: "从此处编辑",
      editConfirmDesc: "将从此处分叉重写。这条消息之后的内容会从当前视图收起,但不会被删除——它作为分支保留,可从分支历史恢复。",
      editConfirmAction: "从此处编辑",
      forkConfirmTitle: "创建新会话",
      forkConfirmDesc: "将以此消息为起点创建新会话。当前会话保留不变,可在会话列表继续访问。",
      forkConfirmAction: "创建新会话",
