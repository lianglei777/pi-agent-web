export const en = {
  ...
  chat: {
    ...
    message: {
      ...
      creating: "Creating...",
      cancel: "Cancel",
      editConfirmTitle: "Edit from here",
      editConfirmDesc: "A new branch starts here. Messages after this collapse from view but are not deleted—they are kept as a branch and recoverable from Branch history.",
      editConfirmAction: "Edit from here",
      forkConfirmTitle: "Create new session",
      forkConfirmDesc: "Starts a new session from this message. The current session is kept unchanged and still available in the session list.",
      forkConfirmAction: "Create new session",
  ...
  sessions: {
    ...
    customProjectPath: "Custom project path",
